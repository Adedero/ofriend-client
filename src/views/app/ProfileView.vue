...
const getUserProfile = (id) => useGet(`api/get-user-profile/${id}`, { router, toast }, (data) => user.value = data)
...
watchEffect(() => getUserProfile(route.params.userId));
    ...
    <div v-if="user">
      ...
      <section class="grid gap-x-3 lg:grid-cols-5 mt-1">
        <div class="w-full relative lg:col-span-2">
          <div
            class="flex flex-col lg:items-center -mt-16 lg:absolute lg:w-full -top-20 lg:-mt-0 lg:-top-20 xl:-top-28">
