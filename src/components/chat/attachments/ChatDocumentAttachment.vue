...
<template>
  <Dialog v-model:visible="visible" modal :closable="false" class="w-80">
    ...
    <div class="card bg-primary text-white p-2 flex gap-2 items-center rounded-md w-full overflow-x-hidden">
  ...
  <div>
    <label class="cursor-pointer flex flex-col items-center" for="document">
      <span
        class="p-3 aspect-square rounded-full grid place-content-center bg-red-400 text-white pi pi-file"></span>
